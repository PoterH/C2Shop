...
export const Home: React.FC = () => {
  ...
  return (
    <div className="pt-0">
      {/* 1. HERO SECTION */}
      <section className="relative bg-[#020617] pt-20 pb-4 md:pt-28 md:pb-6 text-center z-0">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-5 flex flex-col items-center">
          ...
          <div 
            className="w-full max-w-xl md:max-w-3xl lg:max-w-4xl xl:max-w-5xl mt-6 transition-all duration-500 -mb-24 md:-mb-36 lg:-mb-48 xl:-mb-56"
      ...
      {/* Down Arrow 1 (Placed outside Hero to prevent clipping by overflow-hidden) */}
      ...
      {/* 2. CONFIDENCE SECTION (On White Background) */}
      <section id="confidence-section" className="relative pt-28 pb-16 md:pt-44 md:pb-20 lg:pt-56 lg:pb-24 xl:pt-64 xl:pb-28 bg-white scroll-mt-20">
        ...
        {/* Wave Divider to transition into Dark Catalog Theme */}
        <div className="absolute bottom-0 left-0 right-0 w-full overflow-hidden leading-none z-20 pointer-events-none">
          <svg className="relative block w-full h-[40px] md:h-[80px]" viewBox="0 0 1440 120" preserveAspectRatio="none">
            <path d="M0,80 Q720,20 1440,80 L1440,120 L0,120 Z" className="fill-[#020617]"></path>
          </svg>
        </div>
      </section>

      {/* Down Arrow 2 (Placed outside Confidence to prevent clipping by overflow-hidden) */}
      <div className="relative z-30 h-0 w-full flex justify-center pointer-events-none">
        <button 
          onClick={() => {
      ...
      {/* 3. CATALOG SECTION (Dark Continuation) */}
      <section id="catalog-section" className="relative bg-[#020617] pt-16 pb-28 md:pt-20 md:pb-36 overflow-hidden border-t border-white/5 z-0 scroll-mt-10">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto mb-8 bg-sky-950/40 border border-sky-800/40 rounded-2xl p-4 text-center flex flex-col md:flex-row items-center justify-center gap-2 text-sky-200 text-sm shadow-sm select-none">
      ...
      {/* Down Arrow 3 (Placed outside Catalog to prevent clipping by overflow-hidden) */}
      <div className="relative z-30 h-0 w-full flex justify-center pointer-events-none">
        <button 
          onClick={() => {
      ...
      <section id="how-it-works-section" className="py-16 md:py-24 bg-white scroll-mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
